...
Where A is the area exposed to wind, C<sub>d</sub> is the drag coefficient and <img src="img/rho.gif"> is the density of air. 

The power of rolling resistance is given by:
<p align="center"> 
<img src="img/roll.gif">
</p>
Where C<sub>rr</sub> is the rolling coefficient and ![](img/phi.PNG) is the angle of incline.
